// Fase 4 — moved from ../events.ts. Old path kept as shim.
//
// In-process pub/sub for OTC v2. When we scale the API horizontally
// this gets swapped for Redis Pub/Sub; the EVENT SHAPE here is the
// API contract, so callers don't need to change at that point.
